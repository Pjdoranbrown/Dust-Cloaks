// =============================================================================
// PROJECTILES.JS - All projectile types (EXACT from original)
// =============================================================================

import { Entity } from './entities.js';
import { META } from './gameState.js';
import { checkCollision } from './utils.js';

// Dependencies injected by game.js
let enemies, takeEnemyDamage, addFloatingText;

export function injectProjectileDependencies(deps) {
...
// MAGE LVL 3: Area DoT
export class FireballZone extends Projectile {
    constructor(x, y) {
        super(x, y, 60, 'rgba(255, 69, 0, 0.4)', 5, 240);
    }
    update() {
        super.update();
...
// SOLDIER: Melee Swipe
export class MeleeSwipe extends Projectile {
...
// SCOUNDREL: Stab
export class DaggerMelee extends Projectile {
    constructor(x, y, tx, ty, damage) {
...
export class Trap extends Projectile {
    constructor(x, y, damage) {
        super(x, y, 15, '#8B4513', damage, 600);
        this.active = true;
    }
    update() {
...
export class StraightShot extends Projectile {
